  ...
  //metoda za provjeru i unos početnih seed podataka
    ...
    async insertSeedParametarKrvneSlike() {
        await this.db.execute(`
            ...
            ('K Eritrociti Erc', 'x 10e12/L', 3.86, 5.08),
            ('K Hemoglobin Hb', 'g/L', 119, 157),
            ('K Hematokrit Hct', 'L/L', 0.356, 0.470),
            ...
            ('S glukoza serum', 'mmol/L', 4.4, 6.1),
            ('S Kreatinin', 'μmol/L', 49, 90),
            ...
            ('Jetreni enzim S Aspartat aminotransfereza AST', 'U/L', 8, 30),
            ('Jetreni enzim S Alanin aminotransfereza ALT', 'U/L', 10, 36),
            ('Jetreni enzim S Gama glutamiltransferezsa GGT', 'U/L', 9, 35),
            ('Upale CRP', 'mg/L', NULL, 5),
            ('S Kolesterol ukupni', 'mmol/L', NULL, 5.0),
            ('S Kolesterol HDL', 'mmol/L', 1.2, NULL),
